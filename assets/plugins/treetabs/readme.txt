 ...
 */
 ...
 2. Создать плагин TreeTabs, вставить в него код plugin.txt
 
 3. В "Конфигурация плагина"  вставить:
 &setting_tabs=ID ресурсов для закладок (1,2,3,4);text;25,48 &setting_tabs_spec_id=ID спец закладки;text;48 
